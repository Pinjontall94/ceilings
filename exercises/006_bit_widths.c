...
// is important: if you haven't already learned, 'a' is a character, but "a" 
// is a string. Try printing the sizeof() for each if you don't believe me ;)
//
...
int main()
{
    ...
    int unsigned const euler = 2718281828459045;
    assert(euler == 2718281828459045);

    int unsigned const negative_fourty_two = -42;
